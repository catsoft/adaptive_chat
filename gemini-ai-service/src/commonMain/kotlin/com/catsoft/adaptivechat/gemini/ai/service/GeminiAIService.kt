...
class GeminiAIService(private val apiKey: String) : AIService {
    ...
    override suspend fun processVoiceInput(audioData: ByteArray): String {
    ...
    override suspend fun processImageInput(imageData: ByteArray): String {
    ...
    override suspend fun processDocumentInput(documentData: ByteArray, fileName: String): String {
